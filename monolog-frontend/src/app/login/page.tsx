    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-surface-alt dark:bg-[#0B1120]">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8 space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-surface-on">Admin Access</h1>
            <p className="text-sm text-text-muted mt-1">Sign in to manage MonoLog</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-surface-on" htmlFor="username">
              Username
            </label>
          ...
          {/* Password */}
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-surface-on" htmlFor="password">
              Password
            </label>
            <div className="relative">
