...
import { ChevronLeft, Edit, ExternalLink, FileText, Plus, Trash2 } from "lucide-react"
    ...
    <div className="p-4 md:p-8 space-y-8">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-surface-on">Manage Articles</h1>
            <p className="text-text-muted text-sm">Organize and edit your blog content.</p>
          </div>
        </div>
        <Link
          href="/dashboard/new"
